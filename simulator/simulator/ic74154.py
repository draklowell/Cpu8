...
class IC74154(Component):
    ...
    def propagate(self):
        ...
        outputs = [
            self.Y0, self.Y1, self.Y2, self.Y3, self.Y4, self.Y5, self.Y6, self.Y7,
            self.Y8, self.Y9, self.Y10, self.Y11, self.Y12, self.Y13, self.Y14, self.Y15
        ]
        ...
        idx = 0
        if self.get(self.A3): idx += 8
        if self.get(self.A2): idx += 4
        if self.get(self.A1): idx += 2
        if self.get(self.A0): idx += 1
