...
namespace asmx
{
    ...
    public:
         ...
         * an error. Otherwise, it creates or updates the symbol with the provided information.
         ...
         * @param binding_type The binding type of the symbol (Local, Global, Weak). Default is Local.
         * @return The defined symbol.
         * @throws std::runtime_error if the symbol is already defined.
         */
        Symbol define(std::string name, SectionType section, uint32_t offset, SymbolBinding binding_type = SymbolBinding::Local);
