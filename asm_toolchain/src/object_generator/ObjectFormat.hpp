...
namespace obj
{
     ...
     * This structure represents a symbol in an object file, including its name, section index,
     * value (offset within the section), and binding type.
     */
     ...
     * This structure represents an object file, containing its sections, symbols, and relocation entries.
     */
    struct ObjectFile
    {
